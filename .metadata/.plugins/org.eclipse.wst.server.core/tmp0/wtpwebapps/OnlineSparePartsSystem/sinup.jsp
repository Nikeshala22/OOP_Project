...
<!-- Error messages container -->
                ...
                <!-- Check if the 'errors' list is not empty (i.e., there are validation errors) -->
                    <c:if test="${not empty errors}">
                    <!-- Display errors as a list -->
                        <ul>
                        <!-- Iterate through each error in the 'errors' list and display it as a list item -->
                            <c:forEach var="error" items="${errors}">
                                <li>${error}</li> <!-- Display individual error message -->
                            </c:forEach>
                        </ul>
                    </c:if>
                </div>
<!-- End Error messages container -->
