...
<!-- catch data that send from useraccount.jsp -->
    ...
    <!-- show now existing data -->
    <!-- pass those data to DeleteCustomerServlet.java -->
    <form action="delete" method="post">
        <label for="customerId">Customer ID:</label><br>
        <input type="text" id="customerId" name="cusid" value="<%=id%>" readonly><br>
        
        <label for="firstName">First Name:</label><br>
        <input type="text" id="firstName" name="firstname" value="<%=firstname%>" readonly><br>
        
        <label for="lastName">Last Name:</label><br>
        <input type="text" id="lastName" name="lastname" value="<%=lastname%>" readonly><br>
        
        <label for="username">User name:</label><br>
        <input type="text" id="username" name="username" value="<%=username%>" readonly><br>
        
        <label for="password">Password:</label><br>
        <input type="password" id="password" name="password" value="<%=pwd%>" readonly><br><br>
